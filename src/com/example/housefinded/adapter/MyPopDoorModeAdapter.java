...
public class MyPopDoorModeAdapter extends BaseAdapter{
	private List<ProductBean> list;
	private Context context;

	public MyPopDoorModeAdapter(Context context,  List<ProductBean> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.door_bg, null);
		}
		
		TextView tv = (TextView) convertView.findViewById(R.id.tv_list_item);
		
		tv.setText(list.get(position).getDoormode());
		return convertView;
	}
