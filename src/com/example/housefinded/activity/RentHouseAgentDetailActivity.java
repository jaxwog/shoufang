...
public class RentHouseAgentDetailActivity extends Activity implements OnClickListener {
	...
	private RentHouseAgentDetailActivity act;
	...
	protected void parseJson(String result) {
		...
		// 总页数
		String totalRowsString = rentHouseBean.getPage().getTotalRows();
		...
		listview.setAdapter(new RentHouseAdapter(dataSecont,
				RentHouseAgentDetailActivity.this));
		listview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
					long arg3) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(RentHouseAgentDetailActivity.this,
	...
	private void setText() {
		...
		tv_name_house.setText(agent.getName() + "的租房源");
	...
	public void onClick(View v) {
		...
		case R.id.rl_house_source:
			Intent intent = new Intent(act, RentHouseSourceActivity.class);
