...
public class NowRequestActivity extends Activity {
	private ImageView iv_back;
	private ImageView iv_share;
	private NowRequestActivity act;
		...
		tv_commit.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				try {
					...
					rp.addBodyParameter("phone", et_number.getText().toString());
					rp.addBodyParameter("des", et_des.getText().toString());
					rp.addBodyParameter("type", "2");
					mhu.send(HttpMethod.POST,
							HttpUrl.BASE_URL+"rest/estate/add", rp,
							new MyHttpCallback() {
								...
								public void onFailureResult(String msg) {
									Toast.makeText(NowRequestActivity.this,
											"联网失败", 0).show();
								}
							});
					}
